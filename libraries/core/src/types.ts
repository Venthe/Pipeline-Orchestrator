...
export namespace Core {
    export interface InputOptions {
        required?: boolean, trimWhitespace?: boolean
    }
...
export namespace Cache {
     ...
     */
    export type restoreCache = (paths: string[], primaryKey: string, restoreKeys?: string[], options?: DownloadOptions) => Promise<string | undefined>
    export type saveCache = (paths: string[], key: string, options?: UploadOptions) => Promise<number>
}
...
export namespace exec {
    ...
    export type exec = (commandLine: string, args?: string[], options?: ExecOptions) => Promise<number>
    export type getExecOutput = (commandLine: string, args?: string[], options?: ExecOptions) => Promise<ExecOutput>
}
