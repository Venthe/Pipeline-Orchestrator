...
class OnContextTest {
    ...
    private static HandledEvent getEvent(String value, Consumer<ObjectNode> mutator) {
        ...
        eu.venthe.pipeline.orchestrator.events.model.EventType eventType = TypeContext.ensure(event);
        ...
        if (eventType.equals(eu.venthe.pipeline.orchestrator.events.model.EventType.WORKFLOW_DISPATCH)) {
        ...
        if (eventType.equals(eu.venthe.pipeline.orchestrator.events.model.EventType.PUSH)) {
