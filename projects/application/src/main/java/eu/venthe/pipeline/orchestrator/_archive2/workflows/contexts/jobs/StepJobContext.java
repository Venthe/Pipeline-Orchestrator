package eu.venthe.pipeline.orchestrator._archive2.workflows.contexts.jobs;
...
public class StepJobContext {
    ...
    public Integer getTimeoutMinutes() {
        return Optional.ofNullable(this.root.get("timeoutMinutes")).map(JsonNode::asInt).orElse(15);
    }

    public Boolean getContinueOnError() {
        return Optional.ofNullable(this.root.get("continueOnError")).map(JsonNode::asBoolean).orElse(false);
    }
