package eu.venthe.pipeline.orchestrator._archive2.events.impl;

import com.fasterxml.jackson.databind.node.ObjectNode;
import com.google.common.collect.Streams;
import eu.venthe.pipeline.orchestrator._archive2.events.contexts.CommitContext;
import eu.venthe.pipeline.orchestrator._archive2.events.contexts.CommitsContext;
import eu.venthe.pipeline.orchestrator._archive2.events.contexts.CommitterContext;
import eu.venthe.pipeline.orchestrator._archive2.events.contexts.RepositoryContext;
import eu.venthe.pipeline.orchestrator._archive2.events.contexts.common.CommitShaContext;
import eu.venthe.pipeline.orchestrator._archive2.events.contexts.common.RefContext;
import eu.venthe.pipeline.orchestrator._archive2.events.model.EventType;
import eu.venthe.pipeline.orchestrator._archive2.events.AbstractHandledEvent;
import eu.venthe.pipeline.orchestrator._archive2.events.contexts.definitions.Commit;
import eu.venthe.pipeline.orchestrator._archive2.events.contexts.definitions.Committer;
import eu.venthe.pipeline.orchestrator._archive2.events.contexts.definitions.Repository;
