package eu.venthe.pipeline.pipeline_mediator.domain.model;

import com.fasterxml.jackson.databind.JsonNode;
import com.fasterxml.jackson.databind.node.ObjectNode;
import com.fasterxml.jackson.databind.node.TextNode;
import eu.venthe.pipeline.pipeline_mediator.domain.model.vo.ContinuousIntegrationEventStatus;
import eu.venthe.pipeline.pipeline_mediator.domain.model.vo.EventStatus;
import eu.venthe.pipeline.pipeline_mediator.domain.repository.AbstractDocument;
//import eu.venthe.pipeline.pipeline_mediator.plugins.jenkins.JenkinsApi;
import eu.venthe.pipeline.pipeline_mediator.infrastructure.queue.kafka.KafkaEventService;
...
//import static eu.venthe.pipeline.pipeline_mediator.plugins.jenkins.JenkinsUtilities.getByPath;
...
//        if (getByPath(getEvent(), "metadata.branchName", JsonNode::asText)
...
//        return getByPath(root, "type", JsonNode::asText)
