package eu.venthe.pipeline.pipeline_mediator.domain.impl;
...
import eu.venthe.pipeline.pipeline_mediator.domain.EventFactory;
import eu.venthe.pipeline.pipeline_mediator.domain.plugins.MediatorService;
import eu.venthe.pipeline.pipeline_mediator.domain.repository.ContinuousIntegrationEventRepository;
...
//        ciEvent.setStatus(payload.getStatus());
    ...
    @Override
    public String queue(RepositoryEvent event) {
        return null;
    }
