/*
package eu.venthe.pipeline.pipeline_mediator.plugins.jenkins;
...
public class JenkinsApi {
    ...
    public ResponseEntity<Void> triggerPipeline(ObjectNode event) throws JsonProcessingException {
        return prepareFileToSend(
                objectMapper.writeValueAsString(event),
                eventFile ->
                        api.jobJobNameBuildWithParametersPostWithHttpInfo(configuration.getJobName(), eventFile)
        );
    }
