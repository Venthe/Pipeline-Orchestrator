...
import eu.venthe.pipeline.orchestrator.organizations.domain.plugins.gerrit.GerritConfiguration;
import eu.venthe.pipeline.orchestrator.organizations.domain.plugins.gerrit.GerritPluginInstance;
