...
import eu.venthe.platform.project.domain.source_configurations.plugins.gerrit.GerritConfiguration;
import eu.venthe.platform.project.domain.source_configurations.plugins.gerrit.GerritPluginInstance;
