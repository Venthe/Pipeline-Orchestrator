...
import eu.venthe.platform.workflow.runs.jobs.steps.StepExecution;
import eu.venthe.platform.workflow.runs.jobs.steps.StepsExecution;
import lombok.Getter;

import java.time.OffsetDateTime;
import java.util.Set;

import static eu.venthe.platform.workflow.runs.jobs.JobRunStatus.*;
