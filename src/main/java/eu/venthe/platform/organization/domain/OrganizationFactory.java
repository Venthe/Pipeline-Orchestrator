...
public class OrganizationFactory {
    ...
    public Pair<Organization, List<DomainTrigger>> create(CreateOrganizationSpecification specification) {
        ...
        var organization = new Organization(specification.organizationName(), new Organization.Source(source, sourceQueryService), messageBroker, repositorysQueryService);
