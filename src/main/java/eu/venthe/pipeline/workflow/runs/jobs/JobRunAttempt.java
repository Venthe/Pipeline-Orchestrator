...
import eu.venthe.pipeline.workflow.runs.jobs.steps.JobCallbackLogEntry;
import eu.venthe.pipeline.workflow.runs.jobs.steps.StepExecution;
import eu.venthe.pipeline.workflow.runs.jobs.steps.StepsExecution;
import lombok.Getter;

import java.time.OffsetDateTime;
import java.util.Set;

import static eu.venthe.pipeline.workflow.runs.jobs.JobRunStatus.*;
