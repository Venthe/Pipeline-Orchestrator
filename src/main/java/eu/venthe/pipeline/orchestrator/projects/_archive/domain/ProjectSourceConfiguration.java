/*
package eu.venthe.pipeline.orchestrator.projects._archive.domain;
...
import eu.venthe.pipeline.orchestrator.projects._archive.api.events.ProjectSourceConfigurationRemovedEvent;
...
public class ProjectSourceConfiguration implements Aggregate<ProjectSourceConfigurationId> {
    ...
    private final ProjectDataAccessService versionControlSystem;
