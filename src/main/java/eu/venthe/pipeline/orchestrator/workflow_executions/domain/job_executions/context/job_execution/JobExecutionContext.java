package eu.venthe.pipeline.orchestrator.workflow_executions.domain.job_executions.context.job_execution;
 ...
 * <p>
 * Contexts, objects, and properties will vary significantly under different workflow run conditions. For example, the
 * matrix context is only populated for jobs in a matrix.
 * <p>
