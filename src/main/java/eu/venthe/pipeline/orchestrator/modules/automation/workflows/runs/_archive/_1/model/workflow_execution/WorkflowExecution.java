/*
package eu.venthe.pipeline.orchestrator.modules.automation.workflows.runs._archive._1.model.workflow_execution;
...
import eu.venthe.pipeline.orchestrator.modules.automation.workflows.runs.WorkflowExecutionJobs;
import eu.venthe.pipeline.orchestrator.modules.automation.workflows.runs.WorkflowExecutionStatus;
...
public class WorkflowExecution implements Aggregate<WorkflowRunId> {
    @Getter
