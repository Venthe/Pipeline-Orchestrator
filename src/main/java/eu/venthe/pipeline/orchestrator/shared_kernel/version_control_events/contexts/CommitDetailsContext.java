...
import eu.venthe.pipeline.orchestrator.shared_kernel.version_control_events.contexts.common.BooleanContext;
import eu.venthe.pipeline.orchestrator.shared_kernel.version_control_events.contexts.common.DateTimeContext;
import eu.venthe.pipeline.orchestrator.shared_kernel.version_control_events.contexts.common.UrlContext;
import eu.venthe.pipeline.orchestrator.shared_kernel.version_control_events.contexts.git.ActorContext;
import eu.venthe.pipeline.orchestrator.shared_kernel.version_control_events.contexts.git.GitHashContext;
import eu.venthe.pipeline.orchestrator.shared_kernel.version_control_events.contexts.git.CommitMessageContext;
import eu.venthe.pipeline.orchestrator.shared_kernel.version_control_events.contexts.common.PathContext;
